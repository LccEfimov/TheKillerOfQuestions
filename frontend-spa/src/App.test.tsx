...
test('renders sections and protected toggle', async()=>{render(<App/>); expect(screen.getByText(/Analytical Lab|T/)).toBeTruthy(); fireEvent.click(screen.getByRole('checkbox')); expect(screen.getByText(/Protected mode enabled/)).toBeTruthy();});
